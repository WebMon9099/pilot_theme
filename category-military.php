 ...
 *
 * Template Name: Archives for Military Institutions
 *
								...
								<div class="category_container"> 
									<ul>
										...
										<li><a style="border-right: 3px solid <?php the_field('article-color'); ?>" href="<?php echo get_permalink($post->ID) ?>">
											<?php echo get_the_post_thumbnail(); ?> <div class="article_title" style="margin-left: 15px"><?php echo $post->post_title ?></div>
											</a></li>
										<?php } ?>
									</ul>
								</div>
