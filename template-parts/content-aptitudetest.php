...
<a href="/category/aptitude-tests/"><img class="kb_back_arrow" src="/parts/return_arrow.svg"><div class="back_to_link">Back to Aptitude Tests</div></a><?php twentysixteen_excerpt(); ?>
	<header class="entry-header" style="background-image: url(/parts/article_page_bg_aptitudetests.svg);">
		...
		<div class="header_text_container">
			...
			<div class="_alt"><span style="color: #345466;"><?php the_title(); ?>: </span></br>Preparation for Assessment</div>
...
<div id="module-purchase" style="border-left: 3px solid #3793d1;">
<div class="purchase-information">
<div class="purchase-header">Preparation Software for the <span style="color: #345466;"><?php the_title(); ?></span> Assessment</div>
<div class="purchase-description">
Use our software in your web browser on PC, Mac, iPhone and Android to prepare for your <?php the_title(); ?> pilot aptitude test.</div>
...
<p>If you have more questions, or need to prepare for a different test, we can answer your questions.</br>
