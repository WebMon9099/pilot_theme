...
.assessment-process-container .completion::after {background-image: url('<?php the_field('aircraft'); ?>') !important}
a.section-link {background-image: url('/parts/flying_school.svg');}
...
<?php if(!is_user_logged_in()): ?>
<div id="module-purchase" style="border-left: 3px solid <?php the_field('article-color-2'); ?>">
